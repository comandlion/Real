                  ...
                  <Button
                    ...
                    className={
                      isEditing
                        ...
                        : "bg-luxury-blue hover:bg-blue-600 text-white"
                    }
                  >
          ...
          >
                    ...
                    <CardContent className="p-6">
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <span className="text-sm font-medium text-luxury-blue">
                            85%
                          </span>
                        </div>
                      </div>
                      ...
                      >
                        ...
                        <div className="p-4">
                          ...
                          <div className="flex justify-between items-center">
                            <span className="font-bold text-luxury-blue">
                              {property.price}
                            </span>
                    ...
                    {listedProperties.map((property) => (
                      ...
                      >
                        ...
                        <div className="text-right">
                          <div className="font-bold text-luxury-blue mb-1">
                            {property.price}
                          </div>
            ...
            <TabsContent value="settings" className="space-y-6">
              <div className="grid lg:grid-cols-2 gap-6">
                <Card className="border-0 shadow-lg">
                  <CardContent className="p-6">
                    <h3 className="text-lg font-semibold text-luxury-navy mb-6">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-sm text-gray-600">
                            Alert for new properties in your area
                          </p>
                        </div>
                  ...
                  <div className="space-y-4">
                    {recentActivity
                      .concat([
                        {
                          type: "listed",
                          title: "Listed Elegant Family Home",
                          time: "2 weeks ago",
                          icon: Home,
                        },
                        {
                          type: "searched",
                          title: "Searched properties in Austin",
                          time: "3 weeks ago",
                          icon: TrendingUp,
                        },
                        {
                          type: "contacted",
                          title: "Contacted agent for Villa tour",
                          time: "1 month ago",
                          icon: Phone,
                        },
                      ])
