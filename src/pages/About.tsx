...
export default function About() {
  ...
  const teamMembers = [
    ...
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1519244703995-f4e0f30006d5?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80",
  ...
  const values = [
    ...
    },
    {
      ...
      description:
        "Your goals and satisfaction are at the center of everything we do.",
    },
    {
      icon: TrendingUp,
      title: "Excellence",
  ...
  const achievements = [
    ...
    {
      year: "2021",
      achievement: "Fastest Growing Agency - Regional Recognition",
    },
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      ...
      <section className="relative py-20 lg:py-32 overflow-hidden">
        ...
        <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1560518883-ce09059eeffa?ixlib=rb-4.0.3&auto=format&fit=crop&w=1600&q=80')] bg-cover bg-center"></div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl text-gray-200 max-w-3xl mx-auto mb-8">
              For over 15 years, we've been transforming the real estate
              experience through innovation, integrity, and an unwavering
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to="/properties">
                <Button
                  size="lg"
                  className="bg-luxury-gold hover:bg-yellow-500 text-luxury-navy font-semibold"
                >
                  View Properties
              ...
              <Link to="/contact">
                <Button
                  size="lg"
                  variant="outline"
                  className="text-white border-white hover:bg-white hover:text-luxury-navy"
                >
                  Get In Touch
                </Button>
              </Link>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <div className="space-y-4 text-gray-600">
                <p>
                  Founded in 2009 by Sarah Mitchell, Premium Realty began with a
                  simple mission: to revolutionize the real estate experience
                  through personalized service, cutting-edge technology, and
                  unwavering integrity.
                </p>

                <p>
                  What started as a small boutique agency has grown into one of
                  the region's most trusted real estate firms, but we've never
                  lost sight of our core values. Every client relationship is
                  built on trust, expertise, and a genuine commitment to
                  achieving their real estate goals.
                </p>

                <p>
                  Today, Premium Realty stands as a beacon of excellence in the
                  industry, recognized for our innovative approach, market
                  expertise, and the exceptional results we deliver for our
                  clients.
                </p>
              </div>
            </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              ...
              every interaction and the driving force behind our success.
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Our diverse team of real estate professionals brings decades of
              combined experience and a passion for helping clients achieve
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-gray-600 mb-8">
                From first-time homebuyers to seasoned investors, we offer a
                full suite of real estate services tailored to your unique needs
                and goals.
              </p>
            ...
            >
              <Card className="p-6 bg-gradient-to-br from-luxury-blue to-luxury-navy text-white">
                ...
                <p className="text-blue-100">
                  We understand that every real estate journey is unique. Our
                  personalized approach ensures you receive the attention and
              ...
              <Card className="p-6 bg-gradient-to-br from-luxury-gold to-yellow-500 text-luxury-navy">
                ...
                <p className="text-yellow-800">
                  Our team's extensive market knowledge and data-driven insights
                  give you a competitive advantage in today's dynamic real
                  estate market.
                </p>
              </Card>
            </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              ...
              leaders and satisfied clients throughout our journey.
            </p>
          </motion.div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl text-gray-200 mb-8">
              ...
              estate experience. Contact us today to get started.
            </p>
