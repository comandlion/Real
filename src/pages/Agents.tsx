...
const agents = [
  {
    ...
    description:
      "Specializing in luxury properties with over 8 years of experience in the premium market.",
  },
  {
    id: 2,
    name: "Michael Chen",
    ...
    description:
      "Expert in commercial properties and investment opportunities throughout Los Angeles.",
  },
  {
    id: 3,
    ...
    description:
      "Dedicated to helping first-time buyers navigate the home buying process with ease.",
  },
  {
    id: 4,
    name: "David Thompson",
    ...
    description:
      "Premier agent for luxury estates and waterfront properties along the coast.",
  },
  {
    id: 5,
    name: "Lisa Wang",
    ...
    description:
      "Specializing in corporate relocations and helping families find their perfect new home.",
  },
  {
    id: 6,
    name: "Robert Garcia",
    ...
    description:
      "Expert in new construction properties and modern developments in emerging neighborhoods.",
  },
];
      ...
      >
        ...
        >
          ...
          <motion.p
            ...
            variants={itemVariants}
          >
            Our experienced agents are dedicated to helping you find the perfect
            property and navigate your real estate journey.
          </motion.p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Get to know our team of dedicated professionals who are ready to
              ...
              >
                <Card className="border-0 shadow-lg hover:shadow-2xl transition-all duration-500 overflow-hidden">
                  ...
                  <CardContent className="p-6">
                    ...
                    <p className="text-luxury-blue font-medium mb-3">
                      {agent.title}
                    </p>
                      ...
                      <div className="flex gap-2">
                        ...
                        >
                          <Button
                            variant="outline"
                            size="sm"
                            className="w-full hover:bg-luxury-blue hover:text-white"
                          >
      ...
      <section className="py-20 bg-gradient-to-r from-luxury-navy to-luxury-blue text-white">
        ...
        >
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            ...
            towards finding your perfect property.
          </p>
