      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        >
          ...
          <motion.p
            ...
            variants={itemVariants}
          >
            Discover exceptional properties in prime locations with our expert
                  ...
                  <div className="relative overflow-hidden">
                    ...
                    >
                      <Button
                        size="sm"
                        variant="ghost"
                        className="bg-white/90 hover:bg-white text-gray-700 transition-all duration-300"
                      >
                    ...
                    <div className="absolute bottom-4 left-4">
                      <Badge
                        variant="secondary"
                        className="bg-white/90 text-luxury-navy backdrop-blur-sm"
                      >
                        {property.type}
                      </Badge>
                    </div>
            ...
            <Link to="/properties">
              ...
              >
                <Button
                  variant="outline"
                  size="lg"
                  className="border-luxury-blue text-luxury-blue hover:bg-luxury-blue hover:text-white transition-all duration-300 group"
                >
                  View All Properties
                  <ArrowRight className="h-4 w-4 ml-2 group-hover:translate-x-1 transition-transform" />
                </Button>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          >
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Button
                size="lg"
                className="bg-luxury-gold hover:bg-yellow-500 text-luxury-navy font-semibold transition-all duration-300"
              >
            ...
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Button
                size="lg"
                variant="outline"
                className="border-white text-white hover:bg-white hover:text-luxury-navy transition-all duration-300"
              >
                Contact Us Today
              </Button>
            </motion.div>
