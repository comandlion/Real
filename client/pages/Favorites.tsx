...
export default function Favorites() {
  ...
  const getPriceChange = (property: any) => {
    ...
    const current = property.priceHistory[property.priceHistory.length - 1].price;
      ...
      >
        ...
        >
          ...
          <motion.p 
            ...
            variants={itemVariants}
          >
            Keep track of properties you love and never miss out on your dream home.
          </motion.p>
          ...
          >
            <div className="text-center">
              <div className="text-2xl font-bold text-luxury-gold">{favorites.length}</div>
        ...
        {favorites.length > 0 ? (
              ...
              <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div className="flex items-center space-x-4">
                  <span className="text-gray-600">
                    Showing <span className="font-semibold text-luxury-blue">{favorites.length}</span> saved properties
                  </span>
                </div>
              ...
              >
                {favorites.map((property, index) => {
                  ...
                  return (
                    ...
                    >
                      <Card className={`group overflow-hidden border-0 shadow-lg hover:shadow-xl transition-all duration-500 bg-white ${viewMode === 'list' ? 'flex' : ''}`}>
                        <div className={`relative overflow-hidden ${viewMode === 'list' ? 'w-80' : ''}`}>
                          ...
                          {priceChange && (
                            <div className="absolute bottom-3 right-3 bg-white/90 backdrop-blur-sm rounded-lg p-2">
                              <div className={`text-xs font-medium ${priceChange.change > 0 ? 'text-red-600' : 'text-emerald-600'}`}>
          ...
          >
            ...
            <p className="text-gray-600 mb-8 max-w-md mx-auto">
              Start exploring properties and save the ones you love. Your favorites will appear here for easy access.
            </p>
